trigger Proposal on Contact (after update) {
  ...
  for (Contact myContact : Trigger.new) {
    if (Trigger.isUpdate) {
      ...
      mail.setReplyTo('medichal.hemanth@gmail.com');
      mail.setSenderDisplayName('Ride Date and Time is Changed...!');
    
      // (Optional) Set list of people who should be CC'ed
      List<String> ccTo = new List<String>();
      ccTo.add('hemi.medichal@gmail.com');
